...
class HashTagScraper:
    """インスタハッシュタグを取得するスクレイパー"""
    @classmethod
    def scrape_insta_hashtags(cls):
        ...
        for camera_id, camera in cameras.items():
            ...
            shaped_camera_name = cls.shape_camera_name(camera["name"])
            posted_count = cls.scrape_hashtag_count(shaped_camera_name)
    ...
    @classmethod
    def scrape_hashtag_count(cls, camera_name):
        """
    ...
    @classmethod
    def shape_camera_name(cls, camera_name):
        """
