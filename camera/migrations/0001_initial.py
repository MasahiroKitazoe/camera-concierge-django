# Generated by Django 2.1.3 on 2019-01-14 04:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count', models.IntegerField(verbose_name='ハッシュタグ数')),
                ('week_increase', models.IntegerField(verbose_name='週間ハッシュタグ増加数')),
            ],
        ),
        migrations.AddField(
            model_name='review',
            name='camera',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='camera.Camera'),
        ),
        migrations.AddField(
            model_name='camera',
            name='camera_type',
