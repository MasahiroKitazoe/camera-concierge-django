# Generated by Django 2.1.1 on 2018-11-11 11:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='camera',
            name='camera_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='search.CameraType'),
        ),
        migrations.AddField(
            model_name='camera',
            name='finder',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='search.Finder'),
        ),
        migrations.AddField(
            model_name='camera',
            name='frame',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='search.Frame'),
        ),
        migrations.AddField(
            model_name='camera',
            name='maker',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='search.Maker'),
        ),
    ]
